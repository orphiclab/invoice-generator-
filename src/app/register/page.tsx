    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: 'hsl(222 47% 6%)' }}>
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p style={{ color: 'hsl(215 20% 55%)' }}>Start sending invoices in under 60 seconds</p>
        </div>

        <div className="glass rounded-2xl p-8 glow">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm font-medium" style={{ color: 'hsl(210 40% 85%)' }}>Full name</Label>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'hsl(215 20% 55%)' }}>
            ...
            <Link href="/login" className="font-medium hover:opacity-80 transition-opacity" style={{ color: 'hsl(262 83% 72%)' }}>
              Sign in
            </Link>
          </p>
        </div>
