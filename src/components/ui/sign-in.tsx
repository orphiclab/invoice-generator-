        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl py-4 font-semibold transition-all hover:opacity-90" style={{ backgroundColor: 'rgba(255,255,255,0.97)', color: '#18181b' }}>
                Sign In
              </button>
            </form>
