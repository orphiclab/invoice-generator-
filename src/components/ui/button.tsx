  ...
  "group/button inline-flex shrink-0 items-center justify-center gap-1.5 border font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/40 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        default:
          "bg-[#a28ef9] text-white border-transparent rounded-2xl shadow-sm hover:bg-[#8f78f5] hover:shadow-md",
        ...
        outline:
          "bg-white border-[#e5e7eb] text-[#374151] rounded-2xl hover:bg-gray-50 hover:border-[#d1d5db]",
        // Secondary — mint green
        secondary:
          "bg-[#a4f5a6] text-[#166534] border-transparent rounded-2xl hover:bg-[#86efac]",
        // Ghost — no bg, subtle hover
        ghost:
          "bg-transparent border-transparent text-[#374151] rounded-2xl hover:bg-gray-100",
        // Destructive
        destructive:
          "bg-red-50 text-red-600 border-red-200 rounded-2xl hover:bg-red-100",
        // Link
