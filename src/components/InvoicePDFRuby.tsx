...
// ── Ruby Red Palette ──────────────────────────────────────────────
const RUBY        = '#DC2626'   // Vivid red
const RUBY_DARK   = '#7F1D1D'   // Deep burgundy
const RUBY_MID    = '#B91C1C'   // Mid red
const CRIMSON     = '#EF4444'   // Bright crimson
const RUBY_PALE   = '#FEF2F2'   // Softest red bg
const RUBY_LIGHT  = '#FECACA'   // Light red accent
const WHITE       = '#FFFFFF'
const DARK        = '#1C1917'
const MUTED       = '#78716C'
const BORDER      = '#FDE8E8'
...
const styles = StyleSheet.create({
  ...
  // ── Header: deep burgundy w/ crimson accents ────────────────────
  header: { backgroundColor: RUBY_DARK, paddingHorizontal: 44, paddingTop: 34, paddingBottom: 28 },
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  logoCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: RUBY, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  companyName: { fontSize: 18, fontFamily: 'Helvetica-Bold', color: WHITE, marginBottom: 4 },
  companyDetail: { fontSize: 8, color: RUBY_LIGHT, marginBottom: 2, opacity: 0.75 },
  invoiceTag: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: CRIMSON, letterSpacing: 4, textTransform: 'uppercase', textAlign: 'right', marginBottom: 6 },
  invoiceNo: { fontSize: 28, fontFamily: 'Helvetica-Bold', color: WHITE, textAlign: 'right' },
  statusChip: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 12, alignSelf: 'flex-end', marginTop: 8 },
  redBar: { height: 4, backgroundColor: RUBY },
  darkBar: { height: 2, backgroundColor: SLATE },

  // ── Meta ─────────────────────────────────────────────────────────
  metaStrip: { flexDirection: 'row', backgroundColor: RUBY_PALE, borderBottomWidth: 1, borderBottomColor: BORDER },
  ...
  metaLabel: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: RUBY, letterSpacing: 1.3, textTransform: 'uppercase', marginBottom: 3 },
  ...
  ftLabel: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: RUBY_MID, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 9, paddingBottom: 5, borderBottomWidth: 1.5, borderBottomColor: RUBY_LIGHT, alignSelf: 'flex-start' },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: RUBY_DARK, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 4, marginBottom: 2 },
  tableHeaderText: { fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: RUBY_LIGHT, textTransform: 'uppercase', letterSpacing: 0.8 },
  rowEven: { flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 10, backgroundColor: RUBY_PALE, borderBottomWidth: 1, borderBottomColor: BORDER },
  ...
  grandRow: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 14, paddingVertical: 12, backgroundColor: RUBY_DARK, alignItems: 'center' },
  grandLabel: { fontSize: 10, fontFamily: 'Helvetica-Bold', color: WHITE },
  grandValue: { fontSize: 17, fontFamily: 'Helvetica-Bold', color: CRIMSON },

  // ── Paid stamp ──────────────────────────────────────────────────
  paidStamp: { marginHorizontal: 34, marginBottom: 14, paddingVertical: 9, backgroundColor: RUBY_PALE, borderRadius: 4, borderWidth: 2, borderColor: RUBY, alignItems: 'center' },
  paidText: { fontSize: 13, fontFamily: 'Helvetica-Bold', color: RUBY_DARK, letterSpacing: 5, textTransform: 'uppercase' },

  // ── Notes ───────────────────────────────────────────────────────
  notesBox: { marginHorizontal: 34, marginBottom: 20, padding: 14, backgroundColor: RUBY_PALE, borderRadius: 4, borderLeftWidth: 4, borderLeftColor: RUBY },
  notesLabel: { fontSize: 7, fontFamily: 'Helvetica-Bold', color: RUBY_MID, letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 5 },
  notesText: { fontSize: 8.5, color: RUBY_DARK, lineHeight: 1.6 },

  // ── Footer ──────────────────────────────────────────────────────
  footer: { backgroundColor: RUBY_DARK, paddingHorizontal: 44, paddingVertical: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto' },
  footerText: { fontSize: 8, color: RUBY_LIGHT },
...
export function InvoicePDFRuby({ invoice }: { invoice: Invoice | null }) {
