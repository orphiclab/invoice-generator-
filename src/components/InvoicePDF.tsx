...
const STATUS_BADGE_STYLES: Record<string, object> = {
  PAID: styles.badgePaid, SENT: styles.badgeSent, DRAFT: styles.badgeDraft, OVERDUE: styles.badgeOverdue,
}
const STATUS_TEXT_COLORS: Record<string, string> = {
  PAID: '#166534', SENT: '#1d4ed8', DRAFT: '#374151', OVERDUE: '#991b1b',
}
        ...
        <View style={styles.headerBand}>
          <View>
            <View style={styles.logoBox}>
              <Text style={{ fontSize: 14, color: '#ffffff', fontFamily: 'Helvetica-Bold' }}>⚡</Text>
            </View>
          ...
          <View>
            ...
            <View style={STATUS_BADGE_STYLES[invoice.status] || styles.badgeDraft}>
              <Text style={{ fontSize: 7, fontFamily: 'Helvetica-Bold', color: STATUS_TEXT_COLORS[invoice.status] || '#374151' }}>
                {invoice.status}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.totalsBox}>
            ...
            {invoice.discount > 0 && (
              <View style={styles.totalLine}>
                ...
                <Text style={[styles.totalLineValue, { color: '#166534' }]}>-{fmt(discountAmt)}</Text>
              </View>
            )}
